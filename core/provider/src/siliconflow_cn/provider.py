...
class SiliconflowCNProvider(BaseProvider):
    ...
    async def get_llm_list(self) -> list[dict]:
        """
        Fetch available models from SiliconFlow CN API.
        Returns a list of model info dicts with at least 'id' and 'name'.
        """
        model_list_url = "https://api.siliconflow.cn/v1/models"
