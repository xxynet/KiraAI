...
const allGroups: ConfigGroup[] = [
  {
    ...
    fields: [
      ...
      { key: 'bot_config.bot.memory_overflow_discard_count', labelKey: 'configuration.message.memory_overflow_discard_count', labelFallback: 'Overflow Discard Count', hintKey: 'configuration.hints.memory_overflow_discard_count', hintFallback: 'How many oldest messages to discard each time the context limit is exceeded', type: 'integer', default: 1, validation: { min: 1, max: 9999, required: true } },
