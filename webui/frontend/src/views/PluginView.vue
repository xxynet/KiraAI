        ...
        <div class="px-6 py-4 flex-1 overflow-y-auto space-y-4">
          <div>
            ...
            <input
              ...
              :readonly="mcpEditMode"
              class="w-full border border-gray-300 dark:border-gray-600 rounded-lg px-3 py-2 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-colors disabled:opacity-60 disabled:cursor-not-allowed"
            >
          </div>
          <div>
...
async function saveMcpForm() {
  if (!mcpEditMode.value && !mcpForm.value.name?.trim()) {
