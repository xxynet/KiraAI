export default {
  ...
  persona: {
    ...
    generator_idea_label: '你希望创建怎样的人设？',
    generator_idea_placeholder: '可填写角色定位、性格、说话风格、兴趣、背景故事或希望的互动方式。',
    generator_hint: '可留空，AI 会为你创作一个适合日常陪伴聊天的人设。生成后你仍可编辑和确认。',
    generate: '生成草稿',
    generating: '正在生成…',
    generate_failed: '生成人设失败',
    no_personas: '未配置人设',
    name: '名称',
    description: '描述',
    actions: '操作',
