export default {
  ...
  header: {
    ...
    update_failed: '更新失败',
    update_backend_outdated: '更新服务尚未加载新版本，请重启 KiraAI 后重试。',
    update_progress_unavailable: '无法获取更新进度，请查看服务端日志。',
    update_progress_title: '正在更新 KiraAI',
    update_rollback_notice: '更新未完成，已尝试恢复更新前的文件。请查看服务端日志。',
    update_stage_webui: '下载 WebUI',
    update_stage_download: '下载项目代码',
    update_stage_verify: '校验更新包',
    update_stage_apply: '应用更新文件',
    update_stage_dependencies: '安装依赖',
    update_stage_restart: '重启服务',
    update_stage_done: '完成',
    update_stage_running: '进行中',
    update_stage_pending: '等待中',
  },
  nav: {
    overview: '概览',
    provider: '提供商',
  ...
  overview: {
    ...
    llm_title: 'LLM 统计',
    llm_calls: 'LLM 调用次数',
    llm_tokens: '总 Token 消耗',
    llm_success_rate: '调用成功率',
    llm_avg_response: '平均响应',
    llm_ms: '毫秒',
    llm_tooltip_input: '输入',
    llm_tooltip_output: '输出',
    llm_tooltip_cached: '缓存',
    llm_model_stats: '模型用量（近24小时）',
  },
  provider: {
    title: '提供商',
    add: '添加提供商',
  ...
  adapter: {
    ...
    qrcode_login: '扫码登录',
    qrcode_login_hint: '扫码成功后会自动填写下方配置，请确认后再保存。',
    qrcode_start: '显示二维码',
    qrcode_retry: '重新获取',
    qrcode_starting: '正在获取二维码…',
    qrcode_pending: '请使用对应的手机应用扫描二维码',
    qrcode_confirmed: '扫码成功，配置已自动填写',
  ...
  persona: {
    ...
    default_title: '默认人设',
    add: '添加人设',
    create_mode_title: '选择创建方式',
    create_with_ai: 'AI 一键生成',
    create_with_ai_hint: '告诉 AI 你的想法，由它生成完整人设草稿。',
    create_manually: '手动填写',
    create_manually_hint: '从空白人设开始，自行填写全部内容。',
    generating: '正在生成…',
    generator_answer_label: '回答 AI 的问题',
    generator_answer_placeholder: '输入你的回答…',
    generator_send: '发送',
  ...
  plugin: {
    ...
    mcp_tool_toggle_label: '启用工具 {name}',
    mcp_tool_toggle_hint: '关闭的工具将从 AI 的工具列表中移除，以节省 token。',
    mcp_tool_toggle_failed: '更新 MCP 工具状态失败',
    ...
    skills_export: '导出',
    skills_export_success: '技能导出成功',
    skills_export_error: '技能导出失败',
    skills_delete: '删除',
    skills_delete_confirm: '确定要删除技能“{name}”吗？',
    skills_delete_success: '技能删除成功',
    skills_delete_error: '技能删除失败',
    scope: '作用域',
    scope_tab_desc: '控制每个会话可用的 MCP 服务器和技能',
    scope_no_sessions: '暂无会话，请先开始对话',
    scope_edit: '编辑作用域',
    scope_mcp_section: 'MCP 服务器',
    scope_skills_section: '技能',
    scope_save_success: '作用域配置已保存',
    scope_save_failed: '保存作用域配置失败',
    scope_load_failed: '加载作用域配置失败',
    scope_mcp_count: '{count} 个 MCP',
    scope_skill_count: '{count} 个技能',
    scope_restricted: '受限',
    scope_global: '全局',
    scope_global_hint: '全局可用',
    scope_mode_allow: '仅允许',
    scope_mode_deny: '禁止',
    scope_mode_allow_hint: '仅列出的会话可以使用此资源',
    scope_mode_deny_hint: '列出的会话无法使用此资源',
    scope_warning: '设置作用域后，将限制或禁止特定会话使用此资源。',
    scope_all_global: '所有资源均为全局可用',
    ...
    check_updates: '检查更新',
    updates_found: '发现 {count} 个插件有更新',
    no_updates: '所有插件已是最新版本',
  ...
  pluginStore: {
    ...
    install_stage_downloading: '正在下载插件…',
    install_stage_dependencies: '正在安装依赖…',
    install_stage_loading: '正在加载插件…',
    install_stage_completed: '插件安装完成',
    install_stage_failed: '插件安装失败',
    install_stage_cancelled: '安装已取消',
    category: '分类',
    all_categories: '全部分类',
    sort: '排序',
    sort_most_starred: '最多星标',
  ...
  sticker: {
    ...
    description: '描述',
    optional: '（可选）',
    id_placeholder: '留空自动生成',
    desc_placeholder: '留空自动识别',
    file: '文件',
  ...
  configuration: {
    ...
    groups: {
      ...
      selfie: '数字生命外观',
      selfie_desc: '数字生命外观参考设置',
      capabilities: '能力设置',
      capabilities_desc: '启用或禁用各项 AI 能力，并自定义其行为',
      image_compression: '图片压缩',
      image_compression_desc: '控制 VLM 识图和原生多模态请求前的图片压缩',
      models: '默认模型',
    ...
    hints: {
      ...
      max_message_interval: '消息之间的最大间隔秒数',
      dynamic_prompt_position: '会话列表、聊天环境、时间等动态信息的注入位置。放到最新用户消息可使系统提示词保持稳定，提高提示词缓存命中率',
      memory_prompt_position: '记忆的注入位置。放到最新用户消息可在记忆变更时保持系统提示词稳定，提高提示词缓存命中率',
      max_tool_loop: '每次响应的最大代理循环迭代次数',
      max_tool_calls_per_turn: '单轮对话中允许的最大工具调用次数',
      tool_call_timeout: '单次工具调用的最大等待秒数，0表示不限制',
      selfie_path: '数字生命外观参考图片路径，支持相对路径（相对于数据目录）和绝对路径',
      max_size_mb: '缓存文件夹允许占用的最大磁盘空间',
      max_files: '缓存文件夹中允许的最大文件数量',
      max_age_hours: '超过此时间的缓存文件将被自动清理',
      check_interval_minutes: '检查临时缓存并执行清理的时间间隔，修改后立即生效',
      log_level: '终端显示的最低日志等级',
      log_file_path: '日志文件路径，留空使用默认路径',
      log_file_max_size: '单个日志文件的最大体积（MB）',
      locale_lang: '后端语言，用于默认提示词等场景',
      locale_tz: '应用程序时区，例如 Asia/Shanghai 或 UTC。留空使用系统时区',
      pypi_mirror: '自定义 PyPI 包索引 URL，用于安装插件依赖。留空使用默认源',
      http_proxy: 'HTTP 代理地址，设置 HTTP_PROXY 和 HTTPS_PROXY 环境变量，重启程序后生效。留空使用系统默认',
      image_recognition_enabled: '自动使用多模态模型描述消息中的图片和表情包',
      image_recognition_mode: '原生模式将图片直接发送给主 LLM；VLM 描述模式会先将图片转换为文字。',
      image_compression_enabled: '在 VLM 识图和原生多模态请求前压缩大图或高分辨率图片。',
      image_compression_max_size: '压缩后的最长边，单位为像素。',
      image_compression_quality: 'JPEG 输出质量，范围为 1 到 100。',
      image_compression_min_size: '仅在图片超过该 MB 大小或最长边超限时压缩。',
      desc_prompt: '自定义图片描述提示词。留空则使用默认提示词，设置后将覆盖默认',
      stt_enabled: '将收到的语音消息转为文字',
    ...
    message: {
      ...
      dynamic_prompt_position: '动态内容注入位置',
      dynamic_prompt_position_system: '系统提示词',
      dynamic_prompt_position_latest_user: '最新用户消息',
      memory_prompt_position: '记忆注入位置',
      max_tool_loop: '最大代理循环次数',
      max_tool_calls_per_turn: '单轮工具调用次数上限',
      tool_call_timeout: '工具调用超时时间（秒）',
      selfie_path: '形象参考图路径',
      image_recognition_enabled: '图片识别',
      image_recognition_mode: '图片处理模式',
      image_recognition_mode_vlm: 'VLM 识图描述',
      image_recognition_mode_native: '原生多模态',
      image_compression_enabled: '图片压缩',
      image_compression_max_size: '图片最长边',
      image_compression_quality: 'JPEG 质量',
      image_compression_min_size: '压缩阈值',
      desc_prompt: '自定义描述提示词',
      stt_enabled: '语音识别',
      tts_enabled: '语音合成',
      ...
      check_interval_minutes: '清理检查间隔（分钟）',
      log_level: '日志等级',
  ...
  sessions: {
    ...
    description: '会话描述',
    capabilities: '会话能力设置',
    capabilities_global: '跟随全局设置',
    capabilities_custom: '自定义设置',
    capabilities_global_hint: '当前会话将实时使用全局能力设置。',
    capabilities_custom_hint: '仅当前会话使用以下自定义能力设置。',
    description_placeholder: '此处填写的内容 AI 可以看到',
    created_at: '创建时间',
    type_dm: '私聊',
    type_gm: '群聊',
    message_count: '消息数',
    ...
    clear_confirm_message: '确定要清空此会话的全部消息吗？此操作无法撤销。',
    clear_success: '会话消息已清空',
    clear_failed: '清空会话消息失败',
    saved: '会话保存成功',
    deleted: '会话删除成功',
  ...
  logs: {
    ...
    pause: '暂停',
    resume: '继续',
    pause_hint: '冻结视图 —— 新日志会先缓冲，不会插入列表',
    resume_hint: '恢复实时日志流并显示缓冲的日志',
    new_logs: '新日志（{count}）',
    jump_to_latest: '跳到最新',
    buffer_overflow: '已丢弃较早的缓冲日志：{count}',
    install_deps: '安装依赖',
    install_packages_label: '包名',
    install_packages_placeholder: '例如：requests numpy==1.26.4 pillow>=10.0（空格分隔）',
    install_btn: '安装',
    install_installing: '启动中...',
    install_close: '关闭',
  ...
  onboarding: {
    progress: '引导进度',
    configuration_description: '按照以下步骤配置 KiraAI 以满足你的使用需求。',
    configuration_hint: '你可以现在打开各配置页面，并按自己的节奏完成设置，也可以进入 KiraAI 后再设置。',
    next: '下一步',
    back: '返回',
    finish: '完成',
    provider: '提供商',
    ...
    persona: '人设',
    persona_hint: '创建 KiraAI 使用的角色和行为设定。',
    close_configuration: '关闭配置页面',
    title: '欢迎使用 KiraAI',
    ...
    english: 'English',
    timezone: '时区（可选）',
    timezone_placeholder: '例如 Asia/Shanghai 或 UTC',
    timezone_hint: '留空时使用系统时区。',
    continue: '继续',
    saving: '正在保存…',
    save_error: '初始设置保存失败，请重试。',
  },
  tokenSetup: {
    title: '设置访问令牌',
    description: '你可以把自动生成的访问令牌更换为自己便于记忆的令牌，也可以直接跳过。',
    new_token: '新令牌',
    new_token_placeholder: '输入新令牌（至少 6 个字符）',
    confirm_token: '确认新令牌',
    confirm_token_placeholder: '再次输入新令牌',
    hint: '当前自动生成的令牌可在终端输出中查看。你也可以跳过，稍后在系统设置中修改。',
    show_token: '显示令牌',
    hide_token: '隐藏令牌',
    save: '保存并继续',
    skip: '跳过',
    saving: '正在保存…',
    token_required: '请输入新令牌。',
    token_too_short: '新令牌至少需要 6 个字符',
    token_mismatch: '两次输入的新令牌不一致',
    token_reserved: '"disabled" 是保留令牌，不能使用。',
    already_completed: '初始设置已完成，请在系统设置中修改令牌。',
    save_error: '令牌设置失败，请重试。',
  },
  configform: {
    invalid_json: 'JSON 格式无效',
