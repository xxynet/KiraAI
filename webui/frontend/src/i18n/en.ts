export default {
  ...
  header: {
    ...
    update_backend_outdated: 'The update service has not loaded the latest version. Restart KiraAI and try again.',
    update_progress_unavailable: 'Unable to retrieve update progress. Check the server log.',
    update_progress_title: 'Updating KiraAI',
    update_rollback_notice: 'The update did not finish. KiraAI attempted to restore the previous files; check the server log.',
    update_stage_webui: 'Download WebUI',
    update_stage_download: 'Download source code',
    update_stage_verify: 'Verify update package',
    update_stage_apply: 'Apply update files',
    update_stage_dependencies: 'Install dependencies',
    update_stage_restart: 'Restart service',
    update_stage_done: 'Done',
    update_stage_running: 'In progress',
    update_stage_pending: 'Pending',
  },
  nav: {
    overview: 'Overview',
    provider: 'Provider',
  ...
  adapter: {
    ...
    qrcode_login_hint: 'The configuration below is filled automatically after scanning. Review it before saving.',
    qrcode_start: 'Show QR Code',
    qrcode_retry: 'Get New Code',
    qrcode_starting: 'Getting QR code…',
    qrcode_pending: 'Scan this QR code with the corresponding mobile app',
    qrcode_confirmed: 'Login succeeded and the configuration was filled automatically',
  ...
  persona: {
    ...
    add: 'Add Persona',
    create_mode_title: 'Choose Creation Method',
    create_with_ai: 'Generate with AI',
    create_with_ai_hint: 'Describe your idea and let AI create a complete persona draft.',
    create_manually: 'Fill in Manually',
    create_manually_hint: 'Start with a blank persona and write every detail yourself.',
    generating: 'Generating…',
    generator_answer_label: 'Answer the AI question',
    generator_answer_placeholder: 'Enter your answer…',
    generator_send: 'Send',
  ...
  plugin: {
    ...
    mcp_template: 'Configuration Template',
    mcp_template_stdio: 'Local Process (stdio)',
    mcp_template_sse: 'SSE',
    ...
    mcp_tool_toggle_label: 'Enable tool {name}',
    mcp_tool_toggle_hint: 'Disabled tools are removed from the AI tool set to save tokens.',
    mcp_tool_toggle_failed: 'Failed to update MCP tool status',
  ...
  pluginStore: {
    ...
    request_failed_status: 'Request failed with status code {status}.',
    install: 'Install',
    installed: 'Installed',
    ...
    install_stage_downloading: 'Downloading plugin…',
    install_stage_dependencies: 'Installing dependencies…',
    install_stage_loading: 'Loading plugin…',
    install_stage_completed: 'Plugin installation complete',
    install_stage_failed: 'Plugin installation failed',
    install_stage_cancelled: 'Installation cancelled',
    category: 'Category',
    all_categories: 'All Categories',
    sort: 'Sort',
    sort_most_starred: 'Most Starred',
  ...
  sticker: {
    ...
    description: 'Description',
    optional: '(optional)',
    id_placeholder: 'Leave empty to auto-generate',
    desc_placeholder: 'Leave empty to auto-recognize',
    file: 'File',
  ...
  configuration: {
    ...
    groups: {
      ...
      image_compression_desc: 'Control image compression before VLM and native multimodal requests',
    ...
    hints: {
      ...
      memory_prompt_position: 'Where memory is placed. Moving it to the latest user message keeps the system prompt stable and improves prompt cache hit rate when memory changes',
      ...
      check_interval_minutes: 'How often the temporary cache is checked for cleanup. Changes take effect immediately',
      ...
      image_recognition_mode: 'Native sends images directly to the main LLM. VLM description converts them to text first.',
      image_compression_enabled: 'Compress large or high-resolution incoming images before VLM and native multimodal requests.',
      image_compression_max_size: 'Longest edge after compression, in pixels.',
      image_compression_quality: 'JPEG output quality from 1 to 100.',
      image_compression_min_size: 'Compress only when this size in MB is exceeded or the image edge is too large.',
    ...
    message: {
      ...
      memory_prompt_position: 'Memory Injection Position',
      ...
      image_recognition_mode: 'Image Processing Mode',
      image_recognition_mode_vlm: 'VLM Description',
      image_recognition_mode_native: 'Native Multimodal',
      image_compression_enabled: 'Image Compression',
      image_compression_max_size: 'Max Image Edge',
      image_compression_quality: 'JPEG Quality',
      image_compression_min_size: 'Compression Threshold',
      ...
      check_interval_minutes: 'Cleanup Check Interval (minutes)',
      log_level: 'Log Level',
  ...
  sessions: {
    ...
    capabilities_global: 'Follow Global Settings',
    capabilities_custom: 'Custom Settings',
    capabilities_global_hint: 'This session uses the global capability settings in real time.',
    capabilities_custom_hint: 'Only this session uses the custom capability settings below.',
    description_placeholder: 'Anything entered here is visible to the AI',
    ...
    clear_confirm_message: 'Are you sure you want to clear all messages in this session? This action cannot be undone.',
    clear_success: 'Session messages cleared',
    clear_failed: 'Failed to clear session messages',
  ...
  tokenSetup: {
    ...
    description: 'You can replace the auto-generated access token with your own memorable token, or skip for now.',
    new_token: 'New Token',
    new_token_placeholder: 'Enter a new token (at least 6 characters)',
    confirm_token: 'Confirm New Token',
    confirm_token_placeholder: 'Re-enter the new token',
    hint: 'The current auto-generated token can be found in the terminal output. You can also skip this and change it later in Settings.',
    show_token: 'Show token',
    hide_token: 'Hide token',
    save: 'Save and Continue',
    skip: 'Skip',
    saving: 'Saving...',
    token_required: 'Please enter a new token.',
    token_too_short: 'New token must be at least 6 characters',
    token_mismatch: 'The two tokens do not match',
    token_reserved: 'The token "disabled" is reserved and cannot be used.',
    already_completed: 'Setup is already complete. Please change the token in Settings.',
    save_error: 'Failed to set the token. Please try again.',
  },
  configform: {
