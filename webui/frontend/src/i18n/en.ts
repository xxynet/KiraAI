export default {
  ...
  persona: {
    ...
    generator_idea_label: 'What kind of persona would you like to create?',
    generator_idea_placeholder: 'You can provide a role, personality, speaking style, interests, background, or preferred interaction style.',
    generator_hint: 'You can leave this blank and let AI create a persona for everyday companion chats. You can still review and edit it before saving.',
    generate: 'Generate Draft',
    generating: 'Generating…',
    generate_failed: 'Failed to generate persona',
